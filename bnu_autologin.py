...
init_url = "http://172.16.202.202"
get_challenge_api = "http://172.16.202.202/cgi-bin/get_challenge"
...
def init_getip():
    ...
    print("初始化获取ip")
    if re.search('id="user_ip" value="(.*?)"', init_res.text) == None:
        # ip = "172.16.222.61"
        ip = get_host_ip()
    else:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='输入账号和密码')
